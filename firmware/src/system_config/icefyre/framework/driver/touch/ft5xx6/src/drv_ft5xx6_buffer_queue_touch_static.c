 ...
 **************************************************************/
DRV_TOUCH_FT5XX6_TOUCH_BUFFER_OBJ gDrvFT5XX6TouchBufferObj[ 10 ];
...
)
{
    ...
    DRV_TOUCH_FT5XX6_TOUCH_BUFFER_OBJ * bufferObj, * iterator;
    unsigned int i;
    ...
    *bufferHandle = DRV_TOUCH_FT5XX6_TOUCH_BUFFER_HANDLE_INVALID;
    ...
    {
        DRV_TOUCH_FT5XX6_AddRegisterRead( &bufferObj->hRegBuffer,
                                      DRV_TOUCH_FT5XX6_REG_TOUCH_STATUS,
                                      1, 
                                      (uint8_t *)&bufferObj->touchData->status );

        if( DRV_TOUCH_FT5XX6_BUFFER_HANDLE_INVALID == bufferObj->hRegBuffer )
        {
    ...
    *bufferHandle = DRV_TOUCH_FT5XX6_TOUCH_BUFFER_HANDLE_INVALID;
    ...
    for(i = 0 ; i < 10; i ++)
    {
        if(!gDrvFT5XX6TouchBufferObj[i].inUse)
        {
            ...
            bufferObj->next          = NULL;
            bufferObj->previous      = NULL;
            bufferObj->flags         = (0 | DRV_TOUCH_FT5XX6_TOUCH_BUFFER_FLAG_MSG_TXRDY_READ );
            bufferObj->hRegBuffer    = NULL;
    ...
    {
        DRV_TOUCH_FT5XX6_AddRegisterRead( &bufferObj->hRegBuffer,
                                      DRV_TOUCH_FT5XX6_REG_TX_BYTES_READY,
                                      1, 
    ...
    *bufferHandle = DRV_TOUCH_FT5XX6_TOUCH_BUFFER_HANDLE_INVALID;
    ...
    for(i = 0 ; i < 10; i ++)
    {
        if(!gDrvFT5XX6TouchBufferObj[i].inUse)
        {
            ...
            bufferObj->next          = NULL;
            bufferObj->previous      = NULL;
            bufferObj->flags         = (0 | DRV_TOUCH_FT5XX6_TOUCH_BUFFER_FLAG_MSG_RXRDY_READ );
            bufferObj->hRegBuffer    = NULL;
    ...
    {
        DRV_TOUCH_FT5XX6_AddRegisterRead( &bufferObj->hRegBuffer,
                                      DRV_TOUCH_FT5XX6_REG_RX_BYTES_READY,
                                      1, 
                                      (uint8_t *)&bufferObj->numHWBytes );
...
// *****************************************************************************
/* Function:
    void DRV_TOUCH_FT5XX6_TOUCH_BufferEventHandlerSet
    (
  ...
  Summary:
    Dynamic implementation of DRV_TOUCH_FT5XX6_BufferEventHandlerSet client interface
    function.

  Description:
    This is the dynamic implementation of DRV_TOUCH_FT5XX6_BufferEventHandlerSet
...
void DRV_TOUCH_FT5XX6_TOUCH_BufferEventHandlerSet
(
    const DRV_TOUCH_FT5XX6_TOUCH_BUFFER_EVENT_HANDLER eventHandler,
    const uintptr_t context
)
{
    ...
    DRV_TOUCH_FT5XX6_BufferEventHandlerSet ( 
                      (DRV_TOUCH_FT5XX6_BUFFER_EVENT_HANDLER) _DRV_TOUCH_FT5XX6_Buffer_EventHandler,
                      (uintptr_t) dObj );
...
/* Function:
  ...
  Summary:
    Dynamic implementation of DRV_TOUCH_FT5XX6_TouchTasks system interface function.

  Description:
    This is the dynamic implementation of DRV_TOUCH_FT5XX6_TouchTasks system interface
    function.
...
void DRV_TOUCH_FT5XX6_TOUCH_Tasks( void )
{
    ...
    _DRV_TOUCH_FT5XX6_TouchBufferQueueTasks(hDriver);
...
/*******************************************************************************
  Function:
    void _DRV_TOUCH_FT5XX6_Buffer_EventHandler( DRV_TOUCH_FT5XX6_BUFFER_EVENT event,
...
{
    DRV_TOUCH_FT5XX6_STATIC_OBJ * dObj = (DRV_TOUCH_FT5XX6_STATIC_OBJ *) NULL;
    DRV_TOUCH_FT5XX6_TOUCH_BUFFER_OBJ * bufObject = 
                             (DRV_TOUCH_FT5XX6_TOUCH_BUFFER_OBJ *) NULL;
    ...
    if ( DRV_TOUCH_FT5XX6_BUFFER_EVENT_COMPLETE == event )
    {
        switch( bufObject->flags )
        { 
            case DRV_TOUCH_FT5XX6_TOUCH_BUFFER_FLAG_STATUS_READ:
            {
                bufObject->size = 6 * bufObject->touchData->status.nTouch;

                if( 0 != bufObject->size )
                {
                    bufObject->flags = DRV_TOUCH_FT5XX6_TOUCH_BUFFER_FLAG_INPUT_READ;
                }
                else
                {
                    bufObject->nCurrentBytes = bufObject->size;
                    bufObject->size          = 0;
                    dObj->event              = DRV_TOUCH_FT5XX6_TOUCH_BUFFER_EVENT_COMPLETE;
                }

                break;
            }

            case DRV_TOUCH_FT5XX6_TOUCH_BUFFER_FLAG_INPUT_READ:
            {
                bufObject->nCurrentBytes = bufObject->size;
                bufObject->size          = 0;
                dObj->event              = DRV_TOUCH_FT5XX6_TOUCH_BUFFER_EVENT_COMPLETE;
            ...
            case DRV_TOUCH_FT5XX6_TOUCH_BUFFER_FLAG_MSG_TXRDY_READ:
            {
                if( bufObject->numHWBytes != 0 )
                {
                    ...
                    bufObject->flags = DRV_TOUCH_FT5XX6_TOUCH_BUFFER_FLAG_MSG_READ;
                }

                break;
            }

            case DRV_TOUCH_FT5XX6_TOUCH_BUFFER_FLAG_MSG_READ:
            {
                ...
                {
                    bufObject->flags = DRV_TOUCH_FT5XX6_TOUCH_BUFFER_FLAG_MSG_TXRDY_READ;
                }

                break; 
            }

            case DRV_TOUCH_FT5XX6_TOUCH_BUFFER_FLAG_MSG_RXRDY_READ:
            {
                if( bufObject->numHWBytes != 0 )
                {
                    if( ( bufObject->size - bufObject->nCurrentBytes ) <= 
                    ...
                    bufObject->flags = DRV_TOUCH_FT5XX6_TOUCH_BUFFER_FLAG_MSG_WRITE;
                }

                break;
            }

            case DRV_TOUCH_FT5XX6_TOUCH_BUFFER_FLAG_MSG_WRITE:
            {
                bufObject->nCurrentBytes += bufObject->numHWBytes;
                ...
                {
                    bufObject->flags = DRV_TOUCH_FT5XX6_TOUCH_BUFFER_FLAG_MSG_RXRDY_READ;
                }
...
void _DRV_TOUCH_FT5XX6_TouchBufferQueueTasks(DRV_TOUCH_FT5XX6_STATIC_OBJ * hDriver)
{
    DRV_TOUCH_FT5XX6_TOUCH_BUFFER_OBJ * bufferObj = 
                           ( DRV_TOUCH_FT5XX6_TOUCH_BUFFER_OBJ * ) NULL;
    ...
    if( NULL != bufferObj )
    {
        if( 0 == bufferObj->size )
        {
            if( ( NULL != hDriver->touchEventHandler ) &&
                ( DRV_TOUCH_FT5XX6_TOUCH_BUFFER_FLAG_INPUT_READ & bufferObj->flags ||
                  DRV_TOUCH_FT5XX6_TOUCH_BUFFER_FLAG_MSG_READ   & bufferObj->flags ||
                  DRV_TOUCH_FT5XX6_TOUCH_BUFFER_FLAG_MSG_WRITE  & bufferObj->flags ) )
            {
                  hDriver->touchEventHandler( DRV_TOUCH_FT5XX6_TOUCH_BUFFER_EVENT_COMPLETE,
                                              (DRV_TOUCH_FT5XX6_TOUCH_BUFFER_HANDLE) bufferObj,
        ...
        if( NULL != hDriver->touchQueue )
        {
            ...
            switch( bufferObj->flags )
            {
                ...
                {
                    DRV_TOUCH_FT5XX6_AddRegisterRead( &bufferObj->hRegBuffer,
                                                  DRV_TOUCH_FT5XX6_REG_TOUCH_0_NIBBLE_0,
                                                  bufferObj->size, 
                ...
                {
                    DRV_TOUCH_FT5XX6_AddRegisterRead( &bufferObj->hRegBuffer,
                                                  DRV_TOUCH_FT5XX6_REG_TX_BUFFER_POINTER,
                ...
                case DRV_TOUCH_FT5XX6_TOUCH_BUFFER_FLAG_MSG_WRITE:
                {   
                    DRV_TOUCH_FT5XX6_AddRegisterWrite( &bufferObj->hRegBuffer,
                                                   DRV_TOUCH_FT5XX6_REG_RX_BUFFER_POINTER,
                                                   bufferObj->numHWBytes, 
                                                   (uint8_t *)&bufferObj->message +
                                                   bufferObj->nCurrentBytes );
